<template>
  <div class="layout-container">
      ...
      <el-header height="60px">
        <div class="header-container">
          ...
          <div class="design-section">
            <el-tooltip content="查看测试对象接入设计" placement="bottom" effect="light">
              <el-button class="design-btn" :icon="Connection" @click="showAccessDesign = true">
                接入设计
              </el-button>
            </el-tooltip>
          </div>
    ...
    <TestObjectAccessDiagram v-model="showAccessDesign" />
  </div>
</template>
...
import TestObjectAccessDiagram from '../components/TestObjectAccessDiagram.vue';
...
const showAccessDesign = ref(false);
  ...
  .el-header {
    ...
    .header-container {
      ...
      .design-section {
        ...
        .design-btn {
          color: var(--secondary-text-color, #c7d7ff);
          border-color: rgba(143, 175, 255, 0.42);
          background: rgba(82, 121, 214, 0.14);
          font-weight: 500;

          &:hover {
            color: #fff;
            border-color: #77a4ff;
            background: rgba(86, 137, 255, 0.28);
            box-shadow: 0 0 14px rgba(92, 141, 255, 0.25);
          }
        }
      }
